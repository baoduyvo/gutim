...
@section('content')
    <form method="post" action="{{ route('admin.memberShip.update', $memberShip->id) }}">
        @csrf
        <!-- Default box -->
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Members Ship create</h3>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" name="description">{{ old('description', $memberShip->description) }}</textarea>
                        </div>
                    </div>
                </div>
